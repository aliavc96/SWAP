...
A continuación copiamos el archivo .sql en la máquina esclavo con del comando scp:

![captura 2](https://github.com/aliavc96/SWAP/blob/master/practicas/practica5/imagenes/copiasqlAesclavo.JPG)

Posteriormente tenemos que llevar a cabo la restauración de la base de datos en la máquina esclavo, para ello creamos una BD 
...
A continuación se muestra el status del esclavo (vemos que la variable Seconds_Behind_Master está a 0, o sea, que no hay ningún error):

![captura 8](https://github.com/aliavc96/SWAP/blob/master/practicas/practica5/imagenes/statusEsclavoFuncionando.PNG)

He comprobado que creando nuevas entradas en la tabla "datos" de la base de datos del maestro, se incluyen también 
